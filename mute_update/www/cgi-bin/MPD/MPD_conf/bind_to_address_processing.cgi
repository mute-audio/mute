...
# bind_to_address_processing.cgi
...
echo    "<meta http-equiv=\"refresh\" content=\"0; /cgi-bin/MPD/MPD_conf/bind_to_address.cgi?${QUERY_STRING_ESC}\">"
echo    "<script>"
...
#### Loading Screen
   ...
   <div id="loading-top2">
     <div class="loader">
        <div class="loadingtext">Setting Bind to Address ...</div>
