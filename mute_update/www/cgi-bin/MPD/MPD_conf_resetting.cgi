...
echo    "<meta http-equiv=\"refresh\" content=\"0; URL=/cgi-bin/MPD/MPD_conf_reset.cgi?${QUERY_STRING_ESC}\">"
echo    "<script>"
...
#### Loading Screen
   ...
   <div id="loading-top2">
     <div class="loader">
        <div class="loadingtext">Resetting MPD Config. ...</div>
