...
echo      "</div>"
echo        "<h3><a href=\"\" target=\"_self\" class=\"button\">Shutting Down...</a></h3>"
echo    "</div>"
...
echo      "</div>"
echo        "<h3><a href=\"\" target=\"_self\" class=\"button\">Reboot</a></h3>"
echo	"</div>"
...
echo "<object data=\"/cgi-bin/poweroff.cgi\" type=\"application/x-httpd-cgi\"></object>"
echo "</body>"
echo "</html>"
