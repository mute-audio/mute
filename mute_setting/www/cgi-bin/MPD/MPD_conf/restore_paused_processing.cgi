...
echo    "<meta http-equiv=\"refresh\" content=\"0; /cgi-bin/MPD/MPD_conf/restore_paused.cgi?${QUERY_STRING_ESC}\">"
echo    "<script>"
...
#### Loading Screen
   ...
   <div id="loading-top2">
     <div class="loader">
        <div class="loadingtext">Switching Restore Paused ...</div>
