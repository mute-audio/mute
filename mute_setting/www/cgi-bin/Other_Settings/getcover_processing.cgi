...
echo    "<meta http-equiv=\"refresh\" content=\"0; URL=/cgi-bin/Other_Settings/getcover.cgi?${QUERY_STRING_ESC}\">"
echo    "<script>"
...
#### Loading Screen
   ...
   <div id="loading-top2">
     <div class="loader">
        <div class="loadingtext">Generating Coverarts ...</div>
